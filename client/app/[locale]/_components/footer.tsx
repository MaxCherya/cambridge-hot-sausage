        ...
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-12">
          ...
          <div data-reveal className="lg:col-span-5">
            ...
            <div className="mt-4 flex gap-3">
              <SocialIcon href="https://www.instagram.com/the_hot_sausage_company" label="Instagram">
              ...
              <SocialIcon href="https://www.facebook.com/share/1CcobhEh6t/" label="Facebook">
              ...
              <SocialIcon href="https://www.tiktok.com/@cambridge_hot_sausage" label="TikTok">
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
